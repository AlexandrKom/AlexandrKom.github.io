$( function() {   
            ...
            submitHandler : function() {
                ...
                $form.ajaxSubmit( {
                    ...
                    beforeSubmit : function( arr, $form ) {
                        $( '.b-loading', $form ).remove();
                        $form.prepend( $loading );
                        $( '.b-loading__circle-wrapper', $loading )
                            .css( { 'margin-left': -1 * $loading.find('.b-loading__text')[0].scrollWidth / 2 } );
                    },
    ...
    $('.i-parallax-scroller').parallaxScroller();

    $('.b-career__next-slide, .b-career__open-positions').on( 'click', function() {
        var $nextPromo = $( $( this ).attr('href') ).next(),
            scrollTo = $nextPromo.length
                ? $nextPromo.offset().top - ( $( window ).height() - $nextPromo.outerHeight() ) / 2
                : $( $( this ).attr('href') ).offset().top,
            speed = $( this ).hasClass('b-career__open-positions') ? SPEED : 'slow';
